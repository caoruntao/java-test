package com.caort.coupon.customer.service.impl;
...
import com.caort.coupon.customer.convert.CouponConverter;
...
public class CouponCustomerServiceImpl implements CouponCustomerService {
    ...
    public SimulationResponse simulateOrderPrice(SimulationOrder order) {
        ...
        order.setCouponInfoList(couponInfos);
    ...
    public Coupon requestCoupon(RequestCoupon request) {
        ...
        if (expTime != null && now >= expTime || Boolean.FALSE.equals(templateInfo.getAvailable())) {
    ...
    public ShoppingCart placeOrder(ShoppingCart order) {
        ...
        if (order.getCouponId() != null) {
            ...
            CouponInfo couponInfo = CouponConverter.convertToCoupon(coupon);
            couponInfo.setTemplate(templateService.loadTemplateInfo(coupon.getTemplateId()));
            order.setCouponInfoList(new ArrayList<>(List.of(couponInfo)));
        }
